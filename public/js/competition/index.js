...
const NUMBER_OF_FIELDS=7, TABLE_NAME="#competitions", DATA_NAME="competition_id", INPUT_NAME="name", ROUTE_NAME="rozgrywki";
...
function clickCreateRowButtons() {   // kliknięcie przycisku dodawania
    $('#showCreateRow').click(function(){       // tworzenie formularza dodawania
        ...
        var communique = "Błąd tworzenia wiersza z formularzem dodawania rozgrywek.";
